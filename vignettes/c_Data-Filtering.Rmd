...
# Missing summary data will be estimated, when possible, by using AVERAGE values for the focal species. The dataframe below contains values of the average clutch size, number of eggs laid per day, incubation period (in days), and nestling period (in days) which the estimation functions will use to estaimte any missing values.
...
# We suggest adding a few days of buffer to the average incubation, nesting, and total nesting period lengths. This is your judgement call based on the biology of the focal species.
max_days <- 
  data.frame(species =  c("bewwre", "carwre"),
             ...
             total = c(60, 55))       # means (build-to-fledge) plus a bit of buffer
