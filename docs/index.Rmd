...
This quick start guide shows demonstrates how to download data and plot the first lay dates of two species. In this guide, and throughout all package documentation, a simplified example dataset is used consisting of Carolina and Bewick's wrens.
...
```{r head of wren D, echo = F, eval = T}
library(DT)
datatable(head(wrens, 10), options = list(paging = F, scrollX = T, scrollY = "300px", searching  = F))
